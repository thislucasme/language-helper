export function similarityPercentage(string1: string, string2: string):number {
    ...
    return Number(similarity.toFixed(2)); // Return the similarity percentage formatted with two decimal places
  }
